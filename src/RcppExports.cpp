...
RcppExport SEXP _RtsneWithP_Rtsne_nn_cpp(SEXP nn_dexSEXP, SEXP nn_distSEXP, SEXP no_dimsSEXP, SEXP perplexitySEXP, SEXP thetaSEXP, SEXP verboseSEXP, SEXP max_iterSEXP, SEXP Y_inSEXP, SEXP initSEXP, SEXP stop_lying_iterSEXP, SEXP mom_switch_iterSEXP, SEXP momentumSEXP, SEXP final_momentumSEXP, SEXP etaSEXP, SEXP exaggeration_factorSEXP, SEXP num_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _RtsneWithP_normalize_input_cpp(SEXP inputSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_RtsneWithP_Rtsne_cpp", (DL_FUNC) &_RtsneWithP_Rtsne_cpp, 16},
    {"_RtsneWithP_Rtsne_nn_cpp", (DL_FUNC) &_RtsneWithP_Rtsne_nn_cpp, 16},
    {"_RtsneWithP_normalize_input_cpp", (DL_FUNC) &_RtsneWithP_normalize_input_cpp, 1},
    {NULL, NULL, 0}
};

RcppExport void R_init_RtsneWithP(DllInfo *dll) {
